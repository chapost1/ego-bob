...
function convertFromGymBarbellUnitToGymPlatesUnit(weight) {
    return UnitConvertor.convert(getGymBarbellUnit().NAME, getGymPlatesUnit().NAME, weight);
}

function convertFromViewUnitToGymPlatesUnit(weight) {
    return UnitConvertor.convert(getViewUnit().NAME, getGymPlatesUnit().NAME, weight);
}

function convertFromGymPlatesUnitToViewUnit(weight) {
    return UnitConvertor.convert(getGymPlatesUnit().NAME, getViewUnit().NAME, weight);
}
...
function createPlatesLoadOptionCardHTML(option, idx, select = false, title) {
    ...
    function createPlatesLoadHTML() {
        ...
        let platesData =
            ...
            Plates On <strong>Each Side</strong> ${getGymPlatesUnit().NAME}
        </div>`;
