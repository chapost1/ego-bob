function UnitConvertor() {
    ...
    const _oz = 35.27396195, _kg = 1, _g = 1000, _us_ton = 0.00110231,
        ...
        _lb = 2.204622621847, _st = 0.15747304442,
        _imp_ton = 0.000984205357142857104, _hg = 10,
        _dag = 100, _dg = 10000, _cg = 100000;
    // standard: kg
    ...
    (init = () => {
        (initUnitsRatios = () => {
            for (const unit in STANDARD_TO_OTHER_UNITS_RATIOS) {
                STANDARD_TO_OTHER_UNITS_RATIOS[`${unit}S`] = STANDARD_TO_OTHER_UNITS_RATIOS[unit];
                if (unit.includes('_')) {
                    STANDARD_TO_OTHER_UNITS_RATIOS[`${unit.replace('_', ' ')}S`] = STANDARD_TO_OTHER_UNITS_RATIOS[unit];
